...
class MeetingResponse {
  ...
  final List<MeetingDate> data;

  MeetingResponse({required this.status, required this.message, required this.data});
...
class MeetingDate {
  ...
  factory MeetingDate.fromJson(Map<String, dynamic> json) => _$MeetingDateFromJson(json);
